...
func ApplyArtifact(ctx context.Context, layers []Artifact, sn snapshots.Snapshotter, a diff.Applier) (digest.Digest, error) {
...
func ApplyLayer(ctx context.Context, layer Artifact, chain []digest.Digest, sn snapshots.Snapshotter, a diff.Applier, opts ...snapshots.Opt) (bool, error) {
